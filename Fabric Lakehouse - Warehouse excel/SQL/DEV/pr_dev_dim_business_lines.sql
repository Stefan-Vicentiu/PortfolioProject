...
CREATE OR ALTER PROCEDURE [dev_data].[pr_dev_dim_business_lines]
AS
BEGIN
...
BEGIN TRY
    ...
    BEGIN
        ...
        CREATE TABLE [dev_data].[BusinessLines] (
    ...
    TRUNCATE TABLE [dev_data].[BusinessLines];

    -- Insert all rows from Lakehouse
    INSERT INTO [dev_data].[BusinessLines] (
        Business_Line_ID,
        Business_Line_Name,
        Region,
        Status
