...
CREATE OR ALTER PROCEDURE [dev_data].[pr_dev_dim_documents]
AS
BEGIN
...
BEGIN TRY
    ...
    BEGIN
        ...
        CREATE TABLE [dev_data].[Documents] (
    ...
    TRUNCATE TABLE [dev_data].[Documents];

    -- Insert all rows from Lakehouse
    INSERT INTO [dev_data].[Documents] (
        Document_ID,
        Document_Number,
        Document_Type,
        Document_Date,
