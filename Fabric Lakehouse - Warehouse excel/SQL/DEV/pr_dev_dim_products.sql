...
CREATE OR ALTER PROCEDURE [dev_data].[pr_dev_dim_products]
AS
BEGIN
...
BEGIN TRY
    ...
    BEGIN
        ...
        CREATE TABLE [dev_data].[Products] (
    ...
    TRUNCATE TABLE [dev_data].[Products];

    -- Insert all rows from Lakehouse
    INSERT INTO [dev_data].[Products] (
        Product_ID,
        Product_Name,
        SKU,
        Category,
    ...
    SELECT 
        ...
        Is_Active,
        Markup_Pct
    FROM [Lakehouse_RawData].[dbo].[dim_products];
