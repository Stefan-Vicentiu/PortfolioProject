...
CREATE OR ALTER PROCEDURE [test_data].[pr_test_dim_employees]
AS
BEGIN
...
BEGIN TRY
    ...
    BEGIN
        ...
        CREATE TABLE [test_data].[Employees] (
    ...
    TRUNCATE TABLE [test_data].[Employees];

    -- Insert all rows from Lakehouse
    INSERT INTO [test_data].[Employees] (
        Employee_ID,
        Employee_Name,
        Department,
        Position,
