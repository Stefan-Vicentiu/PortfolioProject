...
CREATE OR ALTER PROCEDURE [test_data].[pr_test_dim_accounts]
AS
BEGIN
...
BEGIN TRY
    ...
    BEGIN
        ...
        CREATE TABLE [test_data].[Accounts] (
    ...
    TRUNCATE TABLE [test_data].[Accounts];

    -- insert all rows from Lakehouse
    INSERT INTO [test_data].[Accounts] (
        Account_ID,
        Account_Name,
        Account_Type,
        Financial_Statement
