...
CREATE OR ALTER PROCEDURE [test_data].[pr_test_dim_suppliers]
AS
BEGIN
...
BEGIN TRY
    ...
    BEGIN
        ...
        CREATE TABLE [test_data].[Suppliers] (
    ...
    TRUNCATE TABLE [test_data].[Suppliers];

    -- Insert all rows from Lakehouse
    INSERT INTO [test_data].[Suppliers] (
        Supplier_ID,
        Supplier_Name,
        Supplier_Type,
        Country,
