...
CREATE OR ALTER PROCEDURE [test_data].[pr_test_dim_customers]
AS
BEGIN
...
BEGIN TRY    
    ...
    BEGIN
        ...
        CREATE TABLE [test_data].[Customers] (
    ...
    TRUNCATE TABLE [test_data].[Customers];

    -- Insert all rows from Lakehouse
    INSERT INTO [test_data].[Customers] (
        Customer_ID,
        Customer_Name,
        Customer_Type,
        Customer_Segment,
